...
type MySQLConfig struct {
	...
	RestoreDatadir             string   `yaml:"restore_datadir"`
	RestoreStopCommand         []string `yaml:"restore_stop_command"`
	RestoreStartCommand        []string `yaml:"restore_start_command"`
	RestoreFixOwnershipCommand []string `yaml:"restore_fix_ownership_command"`
	...
	CopyBackExtraArgs          []string `yaml:"copy_back_extra_args"`
}
